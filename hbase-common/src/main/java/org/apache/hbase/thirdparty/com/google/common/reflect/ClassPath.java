...
package org.apache.hbase.thirdparty.com.google.common.reflect;

import static org.apache.hbase.thirdparty.com.google.common.base.Preconditions.checkArgument;
import static org.apache.hbase.thirdparty.com.google.common.base.Preconditions.checkNotNull;
import static org.apache.hbase.thirdparty.com.google.common.base.StandardSystemProperty.JAVA_CLASS_PATH;
...
public final class ClassPath {
  ...
  static final class LocationInfo {
    ...
    private void scan(File file, Set<File> scannedUris, ImmutableSet.Builder<ResourceInfo> builder)
      ...
      if (file.isDirectory()) {
        logger.info("Scanning dir: " + file.getPath());
        scanDirectory(file, builder);
      } else {
        logger.info("Scanning jar: " + file.getPath());
