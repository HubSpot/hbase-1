...
public final class HConstants {
  ...
  /**
   * Timestamp to use when we want to refer to the oldest cell. Special! Used in fake Cells only.
   * Should never be the timestamp on an actual Cell returned to a client.
