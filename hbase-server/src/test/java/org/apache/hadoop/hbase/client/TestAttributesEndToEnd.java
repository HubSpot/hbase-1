...
public class TestAttributesEndToEnd {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAttributesEndToEnd.class);
  ...
  static {
    REQUEST_ATTRIBUTES.put("test1", Bytes.toBytes(1));
    REQUEST_ATTRIBUTES.put("test2", Bytes.toBytes(2));
  }
  ...
  public void testAttributes() throws IOException {
    TableName tableName = TableName.valueOf("testAttributes");
