...
class BalancerClusterState {
  ...
  @Expose private Map<Pair<Integer, Integer>, Float> regionIndexServerIndexRegionCachedRatio;
  // Maps regionIndex -> serverIndex with best region cache ratio
  @Expose private int[] regionServerIndexWithBestRegionCachedRatio;
  // Maps regionName -> oldServerName -> cache ratio of the region on the old server
  @Expose Map<String, Pair<ServerName, Float>> regionCacheRatioOnOldServerMap;
